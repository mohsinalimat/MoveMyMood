...
class AlertSubtext: UIViewController {
    ...
    init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?, alertTitle:String?, alertSubTitle:String?, alertSubText:String?, Button1Name:String?, Button2name:String?)   {
